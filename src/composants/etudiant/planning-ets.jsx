...
const PlanningEts = () => {
    ...
    console.log(student.groupe)


    const emp = plannings.filter((planning) => planning.groupe === student.groupe);
    ...
    return (
        <div className="content row" style={content}>
            ...
            <div className="row" style={{ display: "flex" }}>
                <div className="col-5"><h2 style={title}><Calendar style={ico}></Calendar>  Planning de l'Etudiant </h2></div>
            ...
            <div style={planning} className="col-11">
                <div className="row" style={{ display: "flex" }}>
                    ...
                    <div className="col-md-2 col-sm-12 col-xs-12" style={salle1}>
                        <div> {lundis[2].matiere}</div>
                        <div>{lundis[2].debut}</div>
                        <div>{lundis[2].salle}</div>
                    </div>
                    <div className="col-md-2 col-sm-12 col-xs-12" style={salle2}>
                        <div> {lundis[3].matiere}</div>
                ...
                <div className="row"  style={{ display: "flex" }}>
                    ...
                    <div className="col-md-2 col-sm-12 col-xs-12" style={salle1}>
                        <div> {mardis[0].matiere}</div>
                        <div>{mardis[0].debut}</div>
                        <div>{mardis[0].salle}</div>
                    </div>
                    <div className="col-md-2 col-sm-12 col-xs-12" style={salle2}>
                        <div> {mardis[1].matiere}</div>
                    ...
                    <div className="col-md-2 col-sm-12 col-xs-12" style={salle2}>
                        <div> {mardis[2].matiere}</div>
                        <div>{mardis[2].debut}</div>
                        <div>{mardis[2].salle}</div>
                    </div>

                    <div className="col-md-2 col-sm-12 col-xs-12" style={salle1}>
                        <div> {mardis[3].matiere}</div>
                ...
                <div className="row" style={{ display: "flex" }}>
                    ...
                    <div className="col-md-2 col-sm-12 col-xs-12" style={salle2}>
                        <div> {mercredis[0].matiere}</div>
                        <div>{mercredis[0].debut}</div>
                        <div>{mercredis[0].salle}</div>
                    </div>
                    <div className="col-md-2 col-sm-12 col-xs-12" style={salle1}>
                        <div> {mercredis[1].matiere}</div>
                    ...
                    <div className="col-md-2 col-sm-12 col-xs-12" style={salle1}>
                        <div> {mercredis[2].matiere}</div>
                        <div>{mercredis[2].debut}</div>
                        <div>{mercredis[2].salle}</div>
                    </div>
                    <div className="col-md-2 col-sm-12 col-xs-12" style={salle2}>
                        <div> {mercredis[3].matiere}</div>
                ...
                <div className="row" style={{ display: "flex" }}>
                    ...
                    <div className="col-md-2 col-sm-12 col-xs-12" style={salle1}>
                        <div> {jeudis[0].matiere}</div>
                        <div>{jeudis[0].debut}</div>
                        <div>{jeudis[0].salle}</div>
                    </div>
                    <div className="col-md-2 col-sm-12 col-xs-12" style={salle2}>
                        <div> {jeudis[1].matiere}</div>
                    ...
                    <div className="col-md-2 col-sm-12 col-xs-12" style={salle2}>
                        <div> {jeudis[2].matiere}</div>
                        <div>{jeudis[2].debut}</div>
                        <div>{jeudis[2].salle}</div>
                    </div>
                    <div className="col-md-2 col-sm-12 col-xs-12" style={salle1}>
                        <div> {jeudis[3].matiere}</div>
                ...
                <div className="row" style={{ display: "flex" }}>
                    ...
                    <div className="col-md-2 col-sm-12 col-xs-12" style={salle2}>
                        <div> {vendredis[0].matiere}</div>
                        <div>{vendredis[0].debut}</div>
                        <div>{vendredis[0].salle}</div>
                    </div>
                    <div className="col-md-2 col-sm-12 col-xs-12" style={salle1}>
                        <div> {vendredis[1].matiere}</div>
                    ...
                    <div className="col-md-2 col-sm-12 col-xs-12" style={salle1}>
                        <div> {vendredis[2].matiere}</div>
                        <div>{vendredis[2].debut}</div>
                        <div>{vendredis[2].salle}</div>
                    </div>
                    <div className="col-md-2 col-sm-12 col-xs-12" style={salle2}>
                        <div> {vendredis[3].matiere}</div>
                ...
                <div className="container-fluid">
                    <div className="row">
                        <div className="col-12">
                            <div style={social}>
                                <Facebook style={icoFooter}></Facebook>
                                <Instagram style={icoFooter}></Instagram>
                                <Google style={icoFooter}></Google>
                                <Github style={icoFooter}></Github>
                            </div>
                        </div>
                    </div>
                </div>
